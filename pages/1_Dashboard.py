...
if role == "admin":
    ...
    # Catatan kecil untuk pengguna publik/masyarakat umum
    st.markdown("<br>", unsafe_allow_html=True)
    st.info("Catatan: Akses administrasi data (Impor CSV dan CRUD data TPS / Partai) dinonaktifkan untuk publik dan hanya didelegasikan khusus kepada Operator KPU (Admin).")
