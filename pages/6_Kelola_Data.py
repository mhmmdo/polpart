...
setup_page("Kelola Data")

# Check role access
if st.session_state.get("role") != "admin":
    st.error("Akses Ditolak: Anda tidak memiliki izin untuk mengakses halaman ini.")
    st.stop()

render_header("Kelola Data", "Pusat Manajemen Data Pemilu KPU, Impor CSV, Kelola Partai, dan Kelola TPS.")
...
if admin_menu == "Impor CSV":
    ...
    uploaded_file = st.file_uploader("Pilih file CSV dataset KPU tingkat TPS", type=["csv"], key="manage_csv_uploader")
